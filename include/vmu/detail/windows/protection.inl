...
namespace vmu {
    ...
    {
        switch (flags &
                (~(detail::guard | detail::nocache | detail::writecombine))) {
        ...
        default:
            throw std::range_error("unknown protection constant: " +
                                   std::to_string(flags));
        }
    }

    constexpr inline bool protection_t::accessible() const noexcept
    {
        return !(_native & detail::noaccess);
    }

    constexpr inline bool protection_t::readable() const noexcept
    {
        return accessible() &&
               ((_native & detail::readwrite) || (_native & detail::execute_read) ||
                (_native & detail::execute_readwrite) ||
                (_native & detail::readonly) || (_native & detail::writecopy) ||
                (_native & detail::execute_writecopy));
    }

    constexpr inline bool protection_t::writable() const noexcept
    {
        return accessible() && ((_native & detail::readwrite) ||
                                (_native & detail::execute_readwrite) ||
                                (_native & detail::execute_writecopy) ||
                                (_native & detail::writecopy));
    }

    constexpr inline bool protection_t::executable() const noexcept
    {
        return accessible() &&
               ((_native & detail::execute_read) || (_native & detail::execute) ||
                (_native & detail::execute_readwrite) ||
                (_native & detail::execute_writecopy));
    }
